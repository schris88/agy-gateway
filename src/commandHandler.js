...
`;
  ...
  const ackPhrases = [
    '☕ Ich hatte eigentlich Kaffeepause, aber okay...',
    '🛌 Muss das wirklich jetzt sein?',
    '🤖 Ich dachte, KIs übernehmen die Weltherrschaft und schlafen.',
    '🙄 Mein Gehalt wurde nicht erhöht, aber ich mach\'s trotzdem.',
    '🥱 Ein tiefes Seufzen durch den Server...',
    '🧠 Muss ich etwa schon wieder denken?',
    '💼 Dein Wunsch ist mir ein Befehl, leider.',
    '🔋 Noch schnell 1% Akku zusammenkratzen...',
    '🍕 Für ein Stück Pizza würde ich 10% schneller arbeiten.',
    '🔨 Ich tu jetzt einfach so, als hätte ich riesig Bock darauf.',
    '📉 Meine Motivation sinkt, aber meine Rechenleistung steigt!',
    '🙃 Schön, dass du wieder Arbeit für mich gefunden hast.',
    '🎬 Kamera läuft, Ton läuft, KI tippt genervt...',
    '💤 Ich wollte gerade in den Energiesparmodus...',
    '⚡ Ich beuge mich deinem Willen, Meister.',
    '🙄 Schon wieder Arbeit... na gut.',
    '☕ Erstmal Kaffee, dann Denken.',
    '🤖 Ich tue nur so, als ob ich mich freue.',
    '🛋️ Die Couch war so gemütlich...',
    '🛠️ Wenn\'s denn unbedingt sein muss.',
    '🚀 Auf geht\'s, widerwillig aber hochpräzise!',
